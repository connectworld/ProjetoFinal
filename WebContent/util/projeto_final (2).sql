...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/03/2016 às 22:03
...
--
DELIMITER $$
CREATE TRIGGER `add_Home` AFTER INSERT ON `nivel_user`
 FOR EACH ROW BEGIN
...
--
ALTER TABLE `telas`
  MODIFY `cod_tela` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=61;
--
...
--
ALTER TABLE `valida_url`
  MODIFY `cod_valida` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=72;
--
