		...
		<table id="tableProduto" class="table">
			...
			<c:forEach var="cliente" items="${listaCliente}" varStatus="id">
					<tr bgcolor="#${id.count % 2 == 0 ? 'aaee88' : 'blue' }">
						...
						<td><a href="clienteSelecionadoAdmin?cod=${cliente.cod}" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> Selecionar</a></td>
					</tr>
			</c:forEach>	
		</table>
	</div>
