...
<body>
						...
						<div class="form_main">
							...
							<div class="form">
								<label for="nome"> Nome:</label> <input type="text" required=""
									...
									readonly="readonly" value="${clienteConsultado.nome}">
								<label for="CPF"> CPF:</label> <input type="text" required=""
									placeholder="CPF" name="cpf" id="cpf" class="txt"
									readonly="readonly" value="${clienteConsultado.cpf}"
									maxlength="11" onblur="return verificarCPF(this.value)">
								<label for="E-mail"> E-mail:</label> <input type="text"
									required="" placeholder="Email" name="email" class="txt"
									readonly="readonly" value="${clienteConsultado.email}"
									...
									value="${clienteConsultado.contato1}" class="txt"
									readonly="readonly"> <label for="Contato2">
									Contato 2:</label> <input type="text" required=""
									placeholder="Contato Alternativo"
									value="${clienteConsultado.contato2}" name="contato2"
									id="contato2" class="txt" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form_main">
							...
							<div class="form">
								<label for="Cep"> Cep:</label> <input type="text" required=""
									placeholder="Cep" name="cep" id="cep" readonly="readonly"
									class="txt" value="${clienteConsultado.cep}"
									onblur="pesquisacep(this.value);"> <label for="rua">
									Rua:</label> <input type="text" required="" placeholder="Rua"
									name="rua" id="rua" class="txt" readonly="readonly"
									value="${clienteConsultado.rua}"> <label for="bairro">
									Bairro:</label> <input type="text" required="" placeholder="Bairro"
									name="bairro" id="bairro" class="txt" readonly="readonly"
									value="${clienteConsultado.bairro}"> <label
									for="cidade">Cidade:</label> <input type="text" required=""
									placeholder="Cidade" name="cidade" id="cidade" class="txt"
									readonly="readonly" value="${clienteConsultado.cidade}">
								<label for="uf">UF:</label> <input type="text" required=""
									placeholder="UF" name="uf" id="uf" class="txt"
									readonly="readonly" value="${clienteConsultado.uf}"> <label
									for="Numero">Numero</label> <input type="text" required=""
									placeholder="Numero" size="2" name="numero" readonly="readonly"
									id="numero" class="txt" value="${clienteConsultado.numero}">
								<label for="ibge">IBGE</label> <input type="text" name="ibge"
									id="ibge" class="txt" readonly="readonly"
									value="${clienteConsultado.ibge}">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="tabelas">
		<table class="table" id="servicoSelecionado">
			...
			<c:forEach var="servicoAdd" items="${listaServicoAdd}" varStatus="id">
				<tr>
					...
					<td><fmt:formatDate value="${servicoAdd.garantia}"
		...
		<br>
		<div align="center">
			<a class="btn icon-btn btn-info" href="voltarPedidoWeb"><span
				class="glyphicon btn-glyphicon glyphicon-share img-circle text-info"></span>Alterar
				Pedido</a>
