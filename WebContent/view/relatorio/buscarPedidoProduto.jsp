	...
	<div class="spacing">
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <form role="form" action="buscarPedidoPorCod" method="post">
                    <div class="form-group float-label-control">
                        <label for="Data Inicial">Codigo</label>
                        <input type="text" class="form-control" placeholder="codigo" id="codigoPedido" name="cod" size="10" required="required">
                    </div>
                    <input class="button" name="enviar" value="Gerar" type="submit">
                </form>
            </div>
