		...
		<table id="tableProduto" class="table">
			...
			<c:forEach var="servico" items="${listaServico}" varStatus="id">
					<tr bgcolor="#${id.count % 2 == 0 ? 'aaee88' : 'blue' }">
						...
						<td><a class="btn icon-btn btn-danger" href="deletarServico?cod=${servico.cod}"><span class="glyphicon btn-glyphicon glyphicon-trash img-circle text-danger"></span>Deletar</a></td>
					</tr>
